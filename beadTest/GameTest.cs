...
namespace beadTest
{
    ...
    public class GameTest
    {
        ...
        public async Task Start()
        {
            ...
            Assert.AreEqual(2, mGameModel.GameTable.Foods.Count);
            Assert.AreEqual(1, mGameModel.GameTable.NumOfGuards);
        ...
        public async Task EatFood()
        {
            ...
            Assert.AreEqual(1, mGameModel.GameTable.Foods.Count);
        }
